  ...
  return (
    <section className="max-container padding-x min-h-[70vh] py-10 md:pt-20 bg-[#c1d6f2] mt-10 flex flex-col gap-10 md:flex-row justify-between">
        ...
        <div className="flex flex-col w-full md:w-1/2">
            ...
            <a href="mailto:info@willshomes.com" className="underline mt-3 font-medium">0912 816 8542</a>
...
{/* 
                ...
                <input type="text" placeholder="Full name" className="border p-3 rounded-full w-full outline-blue-100 font-poppins text-sm"/>

                <input type="text" placeholder="Email or phone number" className="border p-3 rounded-full w-full outline-blue-100 font-poppins text-sm"/>

                <textarea name="" id="" cols="30" rows="5" className="border w-full rounded-lg p-3 font-poppins outline-blue-100 text-sm" placeholder="How can we help"></textarea>

                <input type="submit" value="Submit" className="w-full p-3 bg-dark-blue rounded-full text-white cursor-pointer font-outfit" />
                <p className="text-center text-[0.8rem] opacity-30 font-poppins">By submitting this form, you consent to receiving calls and texts from us using the contact details you provide.</p>
            </form>
        </div>
